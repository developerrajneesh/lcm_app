  ...
  const [request, response, promptAsync] = AuthSession.useAuthRequest(
    {
      ...
      scopes: ['public_profile', 'email', 'ads_management', 'ads_read', 'business_management', 'whatsapp_business_manage_events', 'whatsapp_business_management', 'whatsapp_business_messaging', 'leads_retrieval'],
    },
    discovery
  );
