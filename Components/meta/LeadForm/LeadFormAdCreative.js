...
export default function LeadFormAdCreative({ campaignData, onNext, onBack }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Add leadgen_form_id if available from campaign data (form creation step)
      if (campaignData.leadgen_form_id) {
        creativePayload.leadgen_form_id = campaignData.leadgen_form_id;
        console.log('✅ Adding leadgen_form_id to creative payload:', campaignData.leadgen_form_id);
      } else {
        console.warn('⚠️ WARNING: leadgen_form_id not found in campaignData:', campaignData);
      }
      ...
      <View style={styles.form}>
        ...
        <View style={styles.inputContainer}>
          <View style={styles.labelRow}>
            <MaterialCommunityIcons name="image" size={20} color="#1877F2" />
            <Text style={styles.label}>
          ...
          {mediaType === "video" && (
            <View>
              {!videoPreview && !videoId && (
                ...
                >
                  <MaterialCommunityIcons name="video" size={24} color="#1877F2" />
        ...
        <View style={styles.inputContainer}>
          <View style={styles.labelRow}>
            <MaterialCommunityIcons name="text" size={20} color="#1877F2" />
            <Text style={styles.label}>
        ...
        <View style={styles.inputContainer}>
          <View style={styles.labelRow}>
            <MaterialCommunityIcons name="format-title" size={20} color="#1877F2" />
            <Text style={styles.label}>
        ...
        <View style={styles.inputContainer}>
          <View style={styles.labelRow}>
            <MaterialCommunityIcons name="text-subject" size={20} color="#1877F2" />
            <Text style={styles.label}>
              Description
            </Text>
          </View>
        ...
        <View style={styles.inputContainer}>
          <View style={styles.labelRow}>
            <MaterialCommunityIcons name="link" size={20} color="#1877F2" />
            <Text style={styles.label}>
