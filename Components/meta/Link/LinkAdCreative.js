  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.form}>
          ...
          {mediaType === "video" && (
            <View>
              {!videoPreview && !videoId && (
                ...
                >
                  <MaterialCommunityIcons name="video" size={24} color="#EC4899" />
        ...
        <View style={styles.inputContainer}>
          <View style={styles.labelRow}>
            <MaterialCommunityIcons name="text" size={20} color="#EC4899" />
            <Text style={styles.label}>
        ...
        <View style={styles.inputContainer}>
          <View style={styles.labelRow}>
            <MaterialCommunityIcons name="format-title" size={20} color="#EC4899" />
            <Text style={styles.label}>
        ...
        <View style={styles.inputContainer}>
          <View style={styles.labelRow}>
            <MaterialCommunityIcons name="text-subject" size={20} color="#EC4899" />
            <Text style={styles.label}>
              Description
            </Text>
          </View>
