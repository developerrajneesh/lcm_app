  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API_BASE_URL}/click-to-link/adsets`,
        adsetPayload,
        {
          headers: {
    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerText}>
          <Text style={styles.title}>Create Ad Set - Link Campaign</Text>
          <Text style={styles.subtitle}>Configure your ad set settings for the link campaign</Text>
        </View>
      </View>
            ...
            <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 10, marginTop: 8 }}>
              {countries.map((country) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    formData.targeting.geo_locations.countries.includes(country.code)
                      ? { borderColor: "#EC4899", backgroundColor: "#FCE7F3" }
                ...
                >
                  ...
                  {formData.targeting.geo_locations.countries.includes(country.code) && (
                    <MaterialCommunityIcons name="check" size={16} color="#EC4899" style={{ marginTop: 4 }} />
                  )}
                </TouchableOpacity>
              ))}
            </View>
              ...
              {[
                ...
                >
                  <MaterialCommunityIcons
                    name={publisher.icon}
                    size={20}
                    color={formData.targeting.publisher_platforms.includes(publisher.value) ? "#EC4899" : "#606770"}
                  />
